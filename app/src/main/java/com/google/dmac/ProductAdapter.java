...
import com.google.dmac.WebViewActivity;
import com.google.dmac.Product;
import com.google.dmac.ClipBoardManager;
...
public class ProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    String result_coupon,expcode;
    public ProductAdapter(Context context, ArrayList<Object> productArrayList) {
        this.context = context;
        this.productArrayList = productArrayList;
    }
  public ProductAdapter(Context context,String couponcode,String k)
  {  this.context =context;
      result_coupon =couponcode;
      expcode = k;
  }
    ...
    private void setProductView(ProductViewHolder holder, final  int position) {
        ...
        holder.layoutSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("product_id",product.getlink());
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView txtScanResult , txtScanNo , txtScanTime,txtexpirydate ;
        ...
        public ProductViewHolder(View itemView) {
           ...
           // txtexpirydate =itemView.findViewById(R.id.expiry_date);
