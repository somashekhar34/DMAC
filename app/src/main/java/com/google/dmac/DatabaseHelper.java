...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_INSTRUCTOR = "create table if not exists "
            ...
            + " product_code varchar(30)," + " scan_time varchar(30), " + " scan_date varchar(30)," + " load_link varchar(30));";
    ...
    public void addProduct(Product product) {
        ...
        values.put("load_link",product.getlink());
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                product.setScanDate(cursor.getString(3));
                 product.setLink(cursor.getString(4));
